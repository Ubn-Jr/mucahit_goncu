...
func main() {
	...
	var isCowHeavy bool
	//TODO
	// tüm değişkenlerde yazım dilini aynı tutmak çok önemlidir
	// camelCase yazım sistemi en ideal yöntemdir go dili için
	// tüm değişken ve fonksiyonların camelCase e uygun olacak şekilde düzeltelim
